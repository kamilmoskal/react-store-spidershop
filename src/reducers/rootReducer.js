const initState = {
    productsList: [
        ...
        {id: 13, species: 'Poecilotheria', name: 'Regalis', stock: 2, price: 120, stadium: '4DC fe', img: 'p_regalis', amount: 1},
        {id: 14, species: 'Poecilotheria', name: 'Metallica', stock: 1, price: 300, stadium: '3.5DC fe', img: 'p_metallica', amount: 1},
...
const rootReducer = (state = initState, action) => {
    ...
    } else if (action.type === 'SAVE_BUYER_DATA'){
        return { 
            ...state,
            buyerData: {
                ...action.data
